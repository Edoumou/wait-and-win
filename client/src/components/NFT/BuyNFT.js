...
class BuyNFT extends Component {
    ...
    onButtonClick = async e => {
        ...
        let numberOfMintedImages = await this.props.NFTContract.methods.counter().call();
    ...
    onBuyButtonClick = async () => {
        ...
        let newOwner = await this.props.NFTContract.methods
            .ownerOf(this.state.imageID).call();
        let imageCID = await this.props.NFTContract.methods.images(this.state.id).call();
    ...
    componentDidMount = async () => {
        let numberOfMintedImages = await this.props.NFTContract.methods.counter()
            .call();
                    ...
                    <Grid columns={3} celled stackable>
                        <Grid.Row>
                            ...
                            <Grid.Column textAlign='center' width={4}>
                                ...
                                <br></br>
                                <div className='token-buy-input'>
                                    <Input fluid labelPosition='right' type='text' placeholder='displayed above the img'>
